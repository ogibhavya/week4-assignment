...
public class ShiftWheelchair implements Wheelchair {
	...
	public ShiftWheelchair() {
		...
		addService("Racing",
			"Wheel Chair - Racing - implicit Wheel Chair", true, 2.99);
		addService("Offroad",
			"Wheel Chair - Offroad - implicit Wheel Chair", false, 2.99);
		addService("Medical",
			"Wheel Chair - Medical - implicit Wheel Chair", false, 3.29);
		addService("Daily",
			"Wheel Chair - Daily - implicit Wheel Chair", false, 3.29);
		addService("Electric",
			"Wheel Chair - Electric - implicit Wheel Chair", false, 3.29);
	}
