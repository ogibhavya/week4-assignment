...
public class ShiftWheelchair implements Wheelchair {
	...
	public ShiftWheelchair() {
		...
		addService("Racing",
				"Wheel Chair - Racing - servicemerger Wheel Chair", true, 2.99);
			addService("Offroad",
				"Wheel Chair - Offroad - servicemerger Wheel Chair", false, 2.99);
			addService("Medical",
				"Wheel Chair - Medical - servicemerger Wheel Chair", false, 3.29);
			addService("Daily",
				"Wheel Chair - Daily - servicemerger Wheel Chair", false, 3.29);
			addService("Electric",
				"Wheel Chair - Electric - servicemerger Wheel Chair", false, 3.29);
		}
